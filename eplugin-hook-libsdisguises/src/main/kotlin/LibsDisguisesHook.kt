...
open class LibsDisguisesHook(
    ...
    inline fun disguiseToPlayers(entity: Entity, disguise: Disguise, playersToViewDisguise: Collection<Player>) = DisguiseAPI.disguiseToPlayers(entity, disguise, playersToViewDisguise)
