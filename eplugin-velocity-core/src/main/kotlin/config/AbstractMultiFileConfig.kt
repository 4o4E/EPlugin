...
abstract class AbstractMultiFileConfig<T : Any> : Savable {
     ...
     * 属于的插件
     */
    abstract override val plugin: EPluginVelocity
     ...
     * @param sender 通知者
     */
    open fun saveDefault(sender: CommandSource?) {}
     ...
     * 从所有文件中加载数据
     */
    open fun load(sender: CommandSource?) {
        saveDefault(sender)
     ...
     * 保存所有数据到对应的文件中
     */
    override fun save(sender: CommandSource?) {
